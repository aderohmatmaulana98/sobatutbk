                ...
                <div class="card-body p-1">
                    <div class="table-responsive">
                        <table class="table mb-0 table-hover">
                            <thead>
                                <tr class="rounded border bg-orange">
                                    <th colspan="2" class="text-light text-center">DATA USER</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <?= form_open('manage_school/userdata/add_ticket') ?>
                ...
                <div class="card-body px-0">
                    <div class="container-fluid">
                        <div class="row mt-3">
                            ...
                            <?php if ($reseller) : ?>
                                <div class="col-md-12 mt-3 mt-md-0 text-right">
                                    <a href="<?= site_url('manage_school/userdata/create_user') ?>" class="bg-biru-muda text-light px-4 h5" style="border-radius: 2em;">+ Add New</a>
                                </div>
                            <?php endif; ?>
                            <div class="col-12">
                                            ...
                                            if (empty($item)) {
                                                ...
                                                foreach ($item as $i) { ?>
                                                    <tr>
                                                        ...
                                                        <td width="1">
                                                            <a href="<?= site_url('manage_school/userdata/index/' . $i['id']) ?>">
                                                ...
                                                if (empty($users_ticket)) {
                                                    ...
                                                    foreach ($users_ticket as $i) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($i['status'] == 0) : ?>
                                                                    <a href="<?= base_url('manage_school/userdata/delete_ticket/' . $i['ticket_id']) ?>" class="btn-hapus">
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?= form_open_multipart('manage_school/userdata/import_user') ?>
            ...
            <div class="modal-footer">
                ...
                <a href="<?= base_url('manage_school/userdata/import_user_format') ?>" class="btn btn-secondary">Download Format</a>
            </div>
            <?= form_close() ?>
        </div>
    </div>
